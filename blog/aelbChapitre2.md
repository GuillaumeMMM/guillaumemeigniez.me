...
I've been willing for 2 years to make a sewing project with some kind of data visualization involved. Since I saw the Arte documentary "Fashion Geek", I follow and admire the work of [Clara Daguin](https://www.claradaguin.com) and [Ying Gao](http://yinggao.ca). They both include elecronic devices in clothes to convey impressions, and to explore the interfaces between body and technology.
...
- Find or draw appropriate patterns
- Sew the clothes
- Setup the sensors with a Raspberry Pi
- Setup the server that saves the data
- Build the interface that reads it
- Write the algorithm that produces the sounds
- Record the movement of the clothes and film it
- Create a video with both sound generated and images
